...
function Movies() {
  ...
  const fetchWorld = (page) => {
    getMovies({page,  pageSize: 4}).then((res) => setData(res.data.articles))
 ...
 gap={6}>
   ...
   <Text fontSize='20px' color='gray.400'>News/Movies</Text>
   <Divider/>
    <Text fontSize='40px' fontFamily='bolder'>Movies</Text>
