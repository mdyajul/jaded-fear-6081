...
import { getScience } from "./Api/api"
 
import ScienceRead from "./Read/ScienceRead"
...
function Science() {
  ...
  const fetchWorld = (page) => {
    getScience({page,  pageSize: 4}).then((res) => setData(res.data.articles))
 ...
 gap={6}>
   ...
   <Text fontSize='20px' color='gray.400'>News/Science</Text>
   <hr/>
    <Text fontSize='40px' fontFamily='bolder'>Science</Text>
